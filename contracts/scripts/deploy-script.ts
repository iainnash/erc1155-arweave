...
async function main() {
  ...
  const fBoysSimpleInstance = (await FBoysSimple.deploy()) as FBoysSimple;
  await fBoysSimpleInstance.deployed();
  const fBoysMarketplaceInstance = (await FBoysMarketplace.deploy(fBoysSimpleInstance.address)) as FBoysMarketplace;
